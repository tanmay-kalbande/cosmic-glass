...
export function ChatInput({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 lg:px-4">
      ...
      >
        ...
        <div className="flex-1 min-w-0 py-2">
          <textarea
            ...
            className="w-full max-h-[150px] bg-transparent border-none outline-none text-[var(--color-text-primary)] placeholder-[var(--color-text-placeholder)] resize-none text-base leading-relaxed"
            rows={1}
